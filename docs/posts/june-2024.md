...
- Re-added our
  [Unsafe Sites Filter](https://github.com/WindowsAurora/MarkschronFilterlist/). This
  can be added to uBlock to stop anything in
  [unsafe sites](https://fmhy.net/unsafe) from loading in your browser.

- We compared Markschron to the badware filter list to make sure we didn't have
