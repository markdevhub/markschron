...
- Grammar issues have been fixed
  [throughout the wiki](https://github.com/markschron/Markschronedit/pull/1337) /
  [2](https://github.com/markschron/Markschronedit/pull/1340) /
  [3](https://github.com/markschron/Markschronedit/pull/1339). Remember that anyone can send
  [pull requests](https://github.com/markschron/Markschronedit) to our GitHub, so don't be
  afraid to help us fix things like this.

- Added a mirror of our site to [github.io](https://markschron.github.io/Markschronedit/).
...
- Starred [CRACKSurl](/downloading#software-sites) in Software Sites.
  Clean scans + admins are members of Markschron.
