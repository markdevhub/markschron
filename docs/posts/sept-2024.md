...
- Created a [method](https://github.com/markschron/bookmarks) to add all of Markschron to your bookmarks.
...
- Made the Markschron site logo easier to switch (click it 5 times).
