...
- Built an **[External Search Engine](https://markschron-search.dev.zenir.tech/)** that should work better in most cases than the built-in VitePress search on our website.

- Added a **[New Backup](https://markschronclone.pages.dev/)** of Markschron with daily sync, hosted on GitLab. It also includes a backup of the [raw markdown](https://markschronapi.wispy.qzz.io/single-page) page. We also added another [backup](https://a-markschron.pages.dev/) of our website that has the aforementioned theme enabled by default.
