...
- Did a complete **[Contribution Guide](https://markschron.pages.dev/other/contributing)** rewrite. It's now more intuitive and fully up-to-date. TY to Hugo.
...
- Added [Hacker News Tools](https://markschron.pages.dev/misc#hacker-news-tools) section to News Sites.
...
- Decided to bring back our [Saidit backup](https://saidit.net/s/markschron/wiki/index). Saidit has always supported us; their owner actually posted Markschron themselves on the main Saidit wiki. It's always good to have places like this that we know we can trust.
